...
<section class="content-header">
    ...
    <div class="content-header-right">
        <a href="vaccination-add.php" class="btn btn-primary btn-sm">Add Vaccination</a>
    </div>
</section>
...
<tr>
    ...
    <td>
        <?php echo $row['date_given'] ? date('Y-m-d', strtotime($row['date_given'])) : '-'; ?>
    </td>
    ...
    <td>
        ...
        <a href="vaccination-view.php?id=<?php echo $row['id']; ?>" class="btn btn-success btn-xs">
            View
        </a>

        <a href="vaccination-edit.php?id=<?php echo $row['id']; ?>" class="btn btn-primary btn-xs">
            Edit
        </a>
