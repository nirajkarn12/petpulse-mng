...
CREATE TABLE IF NOT EXISTS `payment` (
  ...
  `product_code` varchar(50) NOT NULL DEFAULT 'EPAYTEST',
  `amount` decimal(10,2) NOT NULL,
  `tax_amount` decimal(10,2) DEFAULT '0.00',
  `product_service_charge` decimal(10,2) DEFAULT '0.00',
  `product_delivery_charge` decimal(10,2) DEFAULT '0.00',
...
INSERT INTO `payment` (`payment_id`, `owner_id`, `transaction_uuid`, `product_code`, `amount`, `tax_amount`, `product_service_charge`, `product_delivery_charge`, `total_amount`, `status`, `ref_id`, `payment_method`, `signature`, `created_at`, `updated_at`) VALUES
(5, 12, 'TXN-1778648870508', 'EPAYTEST', 10.00, 0.00, 0.00, 0.00, 10.00, 'COMPLETED', NULL, 'esewa', NULL, '2026-05-13 05:07:50', '2026-05-13 07:22:26'),
...
CREATE TABLE IF NOT EXISTS `tbl_payment` (
  ...
  `service_code` varchar(50) NOT NULL DEFAULT 'EPAYTEST',
