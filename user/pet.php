...
<section class="content-header">
    ...
    <div class="content-header-right">
        <a href="pet-add.php" class="btn btn-primary btn-sm">
            Add Pet
        </a>
    </div>
...
/* FETCH ONLY LOGGED IN OWNER PETS */
...
<?php if($row['pet_image']) { ?>
    ...
    <img src="../admin/assets/uploads/pets/<?php echo $row['pet_image']; ?>" class="pet-img">

<?php } else { ?>

    <span class="badge" style="background:#999;">
        No Photo
    </span>
...
<button
    class="btn btn-info btn-xs btn-map"
    onclick="showMap(
        <?php echo (float)$row['pet_latitude']; ?>,
        <?php echo (float)$row['pet_longitude']; ?>,
...
<?php } else { ?>
    ...
    <em style="color:#999;">No location</em>
...
<a href="pet-view.php?id=<?php echo $row['pet_id']; ?>"
class="btn btn-success btn-xs">
View
</a>

<a href="pet-edit.php?id=<?php echo $row['pet_id']; ?>"
